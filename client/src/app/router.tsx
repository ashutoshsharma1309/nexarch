    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            lazy: async () => {
              const { ArchitecturePage } =
                await import('@/features/architecture/architecture-page');
          ...
          },
          {
            path: 'preview/:runId',
            lazy: async () => {
              const { PreviewPage } = await import('@/features/preview/preview-page');
          ...
          },
          {
            ...
            lazy: async () => {
              const { DocumentationPage } =
                await import('@/features/documentation/documentation-page');
